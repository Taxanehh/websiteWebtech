...
<div class="header main-header" id="header">
    ...
    ?>
        <div class="form-container" style="color:white;">
            <h1>Reservation Dashboard</h1>
                ...
                <form action="/api/admin/delete.php" method="post" target="dummyframe">
                    <label for="id">Delete reservation</label><br>
                    <input type="text" id="id" name="id" placeholder="Reservation ID"><br>
                    <input type="submit" value="Delete">
                </form> 
                <form action="/api/admin/edit.php" method="post" target="dummyframe">
                ...
                <form action="/api/admin/create.php" method="post" target="dummyframe">
    ...
    <div class="form-container" style="color:white;">
            <h1>Menu Dashboard</h1>
                ...
                <div style="position:relative">
                <form action="/api/admin/item_admin/delete.php" method="post" target="dummyframe">
                    <label for="id">Delete item</label><br>
                    <input type="text" id="id" name="id" placeholder="Item ID"><br>
                    <input type="submit" value="Delete">
                </form> 
                <form action="/api/admin/item_admin/edit.php" method="post" target="dummyframe">
                ...
                <form action="/api/admin/item_admin/create.php" method="post" target="dummyframe">
